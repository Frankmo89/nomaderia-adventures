                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3 text-sm">
                            <div>
                              ...
                              <ul className="list-disc list-inside text-card-foreground/70">
                                {p.pros?.map((pro, pi) => <li key={pi}>{pro}</li>)}
                              </ul>
                            </div>
                            <div>
                              <p className="text-destructive font-medium mb-1">Contras</p>
                              <ul className="list-disc list-inside text-card-foreground/70">
                                {p.cons?.map((con, ci) => <li key={ci}>{con}</li>)}
                              </ul>
                            </div>
                          </div>
                          <Button asChild size="sm" className="bg-primary hover:bg-primary/90 text-primary-foreground">
                            <a href={p.affiliate_url || "#"} target="_blank" rel="noopener noreferrer">
                              Ver en Amazon <ExternalLink className="ml-1 h-3 w-3" />
                            </a>
                          </Button>
                        </div>
                      </div>
