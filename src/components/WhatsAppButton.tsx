...
const WhatsAppButton = () => {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.93 }}
      className="fixed bottom-[calc(5rem+env(safe-area-inset-bottom,0px))] sm:bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-900 md:h-[60px] md:w-[60px] group"
