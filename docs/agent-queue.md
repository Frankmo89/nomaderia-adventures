...
| **FRANK** | Revisar y resolver todos los `⚠️ VERIFICAR` en `/privacidad` (umbral CCPA/CPRA, plazos de respuesta, entidad legal, y si Stripe Payment Link cambia la sección de datos de pago). |
